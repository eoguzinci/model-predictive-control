...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    fg[0] = 0; // fg[0] stores the cost value
    ...
    for (unsigned int t = 0; t < N; t++) {
      ...
      fg[0] += CppAD::pow(vars[v_start + t] - ref_v, 2); // velocity is considered as an error here
    }
    ...
    for (unsigned int t = 1; t < N; t++) {
      ...
      fg[1 + epsi_start + t] = epsi1 - (psi1 - psides0 - v0 * delta0 / Lf * dt);
